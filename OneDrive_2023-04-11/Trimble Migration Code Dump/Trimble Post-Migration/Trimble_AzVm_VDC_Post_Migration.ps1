##############################################################################
# Script Name   : Trimble_AzVm_VDC_Post_Migration.ps1
# Author        : Naresh Vanamala
# Created Date  : Jan 01st 2023
# Version       : 1.0
# Description   : Script is useful for performing the Post migration Configuration
#                 Activities on Customer VDC Server
# Example       : .\Trimble_AzVm_VDC_Post_Migration.ps1 .\<CustName*>_VDC_Post_Migration.csv
##############################################################################
...
Function ProcessItemImpl($processor, $csvItem, $reportItem) {
    ...
    Do {
        $ManualStepsPrompt = Read-Host -Prompt `
            ...
            1. Update Citrix License server to Azure citrix license server in all VDC Servers
