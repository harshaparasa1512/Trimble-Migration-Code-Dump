##############################################################################
# Script Name   : Trimble_AzVm_TApp_Post_Migration.ps1
...
# Example       : .\Trimble_AzVm_TApp_Post_Migration.ps1 .\<CustName*>_TApp_Post_Migration.csv
##############################################################################
...
Function ProcessItemImpl($processor, $csvItem, $reportItem) {
    ...
    Do {
        $ManualStepsPrompt = Read-Host -Prompt `
            ...
            1. Update Citrix License server to Azure citrix license server in all Test APP Servers
