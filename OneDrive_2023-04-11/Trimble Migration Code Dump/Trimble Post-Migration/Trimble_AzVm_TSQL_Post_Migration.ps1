##############################################################################
# Script Name   : Trimble_AzVm_TSQL_Post_Migration.ps1
...
#                 Activities on Test MS SQL Server
# Example       : .\Trimble_AzVm_TSQL_Post_Migration.ps1 .\<CustName*>_TSQL_Post_Migration.csv
##############################################################################
